...
let SubscriptionController = class SubscriptionController {
    ...
    createSubscription(req, dto) {
        return this.subscriptionService.createSubscription(req.user.schoolId, dto.gradeLevel, dto.billingCycle);
    }
...
exports.SubscriptionController = SubscriptionController = __decorate([
    ...
    (0, roles_decorator_1.Roles)(client_1.UserRole.SCHOOL_ADMIN, client_1.UserRole.PLATFORM_ADMIN),
